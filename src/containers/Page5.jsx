  ...
  <div className="page5">
    <div className="container">
      ...
      <div className="about">
        ...
        <div className="about__part2">
          ...
          <p className="about__paragraph">
            ...
            and scrambled it to make a type specimen book. PageMaker including
      ...
      <div className="footer">
        ...
        Copyright © 2017, Template by
          <a href="https://webthemez.com/free-bootstrap-templates/" className="footer__link">WebThemez.com</a>
        </span>
      </div>
    </div>
  </div>
