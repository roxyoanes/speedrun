...
import { Navbar, Landing, About, Features, Screenshots, Clients, Packages, Download, Footer } from "./Components-page10";
...
import "../styles/page10-download.scss";
import "../styles/page10-footer.scss";
