...
const Video = () => (
  <div className="video">
    ...
    <div className="video__video-wrapper">
      <iframe src="https://player.vimeo.com/video/146742515?title=0&byline=0&portrait=0" className="video__player" frameBorder="0" title="video" allow="autoplay; fullscreen" allowFullScreen />
    </div>
  </div>
);
